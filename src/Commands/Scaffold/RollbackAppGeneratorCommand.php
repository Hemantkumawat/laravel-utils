...
class RollbackAppGeneratorCommand extends BaseCommand
{
     ...
     * @var string
     */
    protected $name = 'hemant:app.rollback';
    ...
    public function handle()
    {
        //parent::handle();
        //$this->call('serve');
//        $this->call('hemant:scaffold', ['model'=>'OptionDetail', '--fieldsFile' => base_path('schema/option_details.json'),'--skip'=>'*', '--migrate'=>'true']);
        ...
        foreach ($schema as $key=>$table) {
            ...
            $this->call('hemant:rollback', $arguments);
